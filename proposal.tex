...
%      {\LARGE\bf Collaborative Research: SaTC: CORE: Small:
% Mixed Assurance Reasoning via Modal Logic}
% \\
% \begin{tabbing}
%  August 15th, 2023\\
%  Program Solicitation NSF 22-517
%  \end{tabbing}
%  \end{raggedright} 
%  % \lujo{need to standardize on capitalization of subsubsections}
%  % \limin{make sure not to duplicate our citations}
